...
当前数据源来自 Hacker News，筛选 7 条可能值得我关注的内容，代替我通过微信公众号获取资讯的习惯。
...
- 最多 5 条技术精选：覆盖 AI、软件开发、编程语言、数据库、计算机系统、互联网技术、开源项目和开发工具等计算机领域；
- 最多 2 条圈外热门内容：从 HN 全站热门候选中选择 2 条非计算机领域的新闻。
...
- 需要给 website 添加上反馈校准：通过真实阅读记录（写下我的评论）定期复盘筛选规则
